...
export function StatCard({
  ...
  return (
    ...
    >
      <p className="text-[0.625rem] font-bold uppercase leading-tight tracking-wider text-clay-600 dark:text-clay-400">
        {label}
      </p>
      ...
      {hint && (
        <p className="mt-1 text-xs text-clay-600 dark:text-clay-400">{hint}</p>
      )}
    </SurfaceCard>
  );
}
